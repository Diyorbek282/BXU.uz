...
import LoginRektor from "./rektor/LoginRektor";
import SubjectsStatistics from "./rektor/SubjectsStatistics";
import SubjectsCheck from "./rektor/SubjectsCheck";
import Attendance from "./rektor/Attendance";
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path={"/rector/login"} element={<LoginRektor />} />
        <Route
          path={"/rector/subjects-statistics"}
          element={<SubjectsStatistics />}
        />
        <Route path={"/rector/subjects-check"} element={<SubjectsCheck />} />
        <Route path={"/rector/attendance"} element={<Attendance />} />
