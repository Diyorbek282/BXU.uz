                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Rollar</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                to="/app/commander"
                                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${isActive("/app/commander")}`}
                            >
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Sozlamalar</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                to="/app/staff"
                                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${isActive("/app/staff")}`}
                            >
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Xodimlar</span>
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link
                                to="/app/folders"
                                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${isActive("/app/folders")}`}
                            >
                                <svg
                                    className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                    aria-hidden="true"
