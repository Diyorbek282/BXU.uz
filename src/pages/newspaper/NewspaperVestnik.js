    ...
    const fetchNewspapers = async () => {
        try {
            ...
            const filteredData = response.data
                .map(yearGroup => ({
                    ...yearGroup,
                    newspapers: yearGroup.newspapers.filter(item => isCyrillic(item.title))
                }))
        ...
        <div className="">
            ...
            >
                ...
                <div className="header_title">
                    <h2 className="my-4">{year && year !== "all" ? `${year} Hamkor jurnallar` : "Hamkor jurnallar"}</h2>
                </div>
            </div>
