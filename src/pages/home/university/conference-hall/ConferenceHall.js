        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg mb-12 border border-gray-100">
            <h1 className="text-2xl md:text-3xl font-bold text-center text-blue-800 mb-6">
              BUXORO XALQARO UNIVERSITETINING KONFRENSIYA ZALI
            </h1>
            <p className="text-gray-700 text-lg leading-relaxed text-center">
              Jami 300 o'ringa mo'ljallangan bo'lib bu yerda ma-naviy-ma'rigiy tadbirlar, 
              konsert dasturlari hamda turli xildagi anjumanlarni o'tkazish uchun barcha 
          ...
          <div className="space-y-8">
            ...
            <div className="relative group overflow-hidden rounded-2xl shadow-xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent flex items-end p-6">
                <span className="text-white text-lg font-medium">300 o'rinli konferensiya zali</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="relative group overflow-hidden rounded-2xl shadow-xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent flex items-end p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="text-white font-medium">Zalning ichki ko'rinishi</span>
                </div>
              </div>
              <div className="relative group overflow-hidden rounded-2xl shadow-xl">
                <img 
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent flex items-end p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="text-white font-medium">Zamonaviy texnika</span>
                </div>
              </div>
            </div>
          </div>
